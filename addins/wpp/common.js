(function (global) {
  ...
  global.RA = { CORE: CORE, $: $, $$: $$, esc: esc, toast: toast, api: api, previewValue: previewValue, checkCore: checkCore, loadSettings: loadSettings, wireSettings: wireSettings, renderFiles: renderFiles };
})(window);
